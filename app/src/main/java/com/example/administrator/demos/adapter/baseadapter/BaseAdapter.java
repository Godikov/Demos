...
public abstract class BaseAdapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    protected OnItemLongClickListeners<T> mItemLongClickListener;
    ...
    protected RelativeLayout mFooterLayout;
...
/*                if (newState == RecyclerView.SCROLL_STATE_IDLE) {
            ...
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                ...
                if(lastCompletelyVisibleItem == getItemCount() - 1 && (dx > 0 || dy > 0)){
                    scrollLoadMore();
    ...
    public void addFooterView2(View footerView) {
        if (footerView == null) {
            return;
        }
